        ...
        <div class="row g-4">
            ...
            <div class="col-sm-6 col-xl-3">
                {{-- <div class="bg-light rounded p-4 text-center"> --}}
                    <button class="btn-link bg-light rounded text-center" style="border:none; padding:15px 90px;"
                        data-status="All Applications" onclick="filterApplications(this)">
            ...
            <div class="col-sm-6 col-xl-3">
                {{-- <div class="bg-light rounded p-4 text-center"> --}}
                    <button class="btn-link bg-light rounded text-center" style="border:none; padding:15px 75px;"
                        data-status="Verified" onclick="filterApplications(this)">
                        <div class="card-box height-100-p widget-style1">
                            <div class="d-flex flex-wrap align-items-center">
                                <div class="progress-data">
                                    <div id="chart4"></div>
            ...
            <div class="col-sm-6 col-xl-3">
                {{-- <div class="bg-light rounded p-4 text-center"> --}}
                    <button class="btn-link bg-light rounded text-center" style="border:none; padding:15px 75px;"
                        data-status="In Process" onclick="filterApplications(this)">
                        <div class="card-box height-100-p widget-style1">
                            <div class="d-flex flex-wrap align-items-center">
                                <div class="progress-data">
                                    <div id="chart4"></div>
            ...
            <div class="col-sm-6 col-xl-3">
                {{-- <div class="bg-light rounded p-4 text-center"> --}}
                    <button class="btn-link bg-light rounded text-center" style="border:none; padding:15px 70px;"
                        data-status="Approved" onclick="filterApplications(this)">
                        <div class="card-box height-100-p widget-style1">
                            <div class="d-flex flex-wrap align-items-center">
                                <div class="progress-data">
                                    <div id="chart4"></div>
                                ...
                                <div class="widget-data">
                                    ...
                                    <div class="weight-600 font-10" style="color:black">Accepted</div>
                                </div>
                            </div>
                        </div>
                    </button>
            ...
            <div class="col-sm-6 col-xl-3">
                {{-- <div class="bg-light rounded p-4 text-center"> --}}
                    <button class="btn-link bg-light rounded text-center" style="border:none; padding:15px 70px;"
                        data-status="Rejected" onclick="filterApplications(this)">
                        <div class="card-box height-100-p widget-style1">
                            <div class="d-flex flex-wrap align-items-center">
                                <div class="progress-data">
                                    <div id="chart4"></div>
...
@section('scripts')
    ...
    <script>
        function filterApplications(button) {
            const status = button.dataset.status;
            const url = "{{ route('filter-apply-loan') }}";
