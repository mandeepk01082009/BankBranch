...
<body class="bg-light">
                ...
                <div class="card">
                    ...
                    <ul id="messages" class="list-unstyled">
                        ...
                        <li style="display: flex; justify-content: space-between;">
                            ...
                            <div style="margin-left: 20px; font-size:12px; color:rgb(110, 110, 110); white-space: nowrap;">
                                <div>
                    ...
                    <form id="applicant-message-form" method="POST" action="{{ route('messStore', $applicantId) }}" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group">
                            <textarea id="applicant-message" name="text" class="form-control" rows="3" placeholder="Type your message here...">{{ old('text') }}</textarea>
                            @error('text')
                        ...
                        <div class="form-group mt-3">
                            <input type="file" id="applicant-file" name="file[]" class="form-control" multiple>
                            @error('file')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="invalid-feedback" id="applicant-field-error" style="display: none;"><strong>
                                Please fill in
                                either the text or the file field.</strong></div>


                        <!-- <div class="form-group mt-3">
                            <select class="form-select" id="applicant-status" name="status" aria-label="Default select example" required>
                            ...
                            @enderror
                            <div id="applicant-status-error" class="invalid-feedback" style="display: none;">
    ...
    <script>
        document.getElementById('applicant-message-form').addEventListener('submit', function(event) {
            var text = document.getElementById('applicant-message').value.trim();
            var file = document.getElementById('applicant-file').value.trim();

            if (!text && !file) {
                event.preventDefault();
                document.getElementById('applicant-field-error').style.display = 'block';
            } else {
                document.getElementById('applicant-field-error').style.display = 'none';
            }
        });
    </script>
