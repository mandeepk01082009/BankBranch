...
/* Hide the last page arrow */
.relative.inline-flex.items-center.px-2.py-2.-ml-px.text-sm.font-medium.text-gray-500.bg-white.border.border-gray-300.rounded-r-md.leading-5.hover:text-gray-400.focus\:z-10.focus\:outline-none.focus\:ring.ring-gray-300.focus\:border-blue-300.active:bg-gray-100.active:text-gray-500.transition.ease-in-out.duration-150.dark:bg-gray-800.dark:border-gray-600.dark:active:bg-gray-700.dark:focus\:border-blue-800:last-child {
    display: none;
}
                                ...
                                <table class="table">
                                    <tbody>
                                        @forelse ($govt_schemes as $scheme)
                                            <tr>
                                                <td><a href="#" class="text-dark">{{ $scheme->scheme }}</a></td>
                                            </tr>
                                        @empty
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <marquee behavior="scroll" direction="up" scrollamount="3" onmouseover="this.stop();"
                                onmouseout="this.start();" style="height: 300px;">
                                <a href="#" class="text-dark py-2">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit, harum.
                                    <p class="mb-0 mt-1 position-relative small"><i
                                            class="far fa-calendar-alt me-1"></i>12-11-2022 <span><img
                                                src="assets/images/new-blinking.gif" width="30" alt=""></span>
                                    </p>
                                </a>
                                <hr>
                                <a href="#" class="text-dark py-2">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit, harum.
                                    <p class="mb-0 mt-1 position-relative small"><i
                                            class="far fa-calendar-alt me-1"></i>11-11-2022 <span><img
                                                src="assets/images/new-blinking.gif" width="30" alt=""></span>
                                    </p>
                                </a>
                                <hr>
                                <a href="#" class="text-dark py-2">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit, harum.
                                    <p class="mb-0 mt-1 position-relative small"><i
                                            class="far fa-calendar-alt me-1"></i>12-10-2022</p>
                                </a>
                                <hr>
                                <a href="#" class="text-dark py-2">
                                    Lorem ipsum dolor sit amet.
                                    <p class="mb-0 mt-1 position-relative small"><i
                                            class="far fa-calendar-alt me-1"></i>19-08-2022</p>
                                </a>
                                <hr>
                                <a href="#" class="text-dark py-2">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit, harum.
                                    <p class="mb-0 mt-1 position-relative small"><i
                                            class="far fa-calendar-alt me-1"></i>11-06-2022</p>
                                </a>
                                <hr>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="text-dark py-2">
                                                    ...
                                                    <p class="mb-0 mt-1 position-relative small"><i
                                                            class="far fa-calendar-alt me-1"></i>12-11-2022 <span><img
                                                                src="assets/images/new-blinking.gif" width="30"
                                                                alt=""></span></p>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="#" class="text-dark py-2">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit, harum.
                                                    <p class="mb-0 mt-1 position-relative small"><i
                                                            class="far fa-calendar-alt me-1"></i>12-11-2022</p>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="card border-0 h-100">
                        ...
                        <div class="card-body p-0">
                            <div class="list-group">
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> Pension Portal</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> ICDS - Schemes for Adolescent Girls</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> Public Grievances Portal</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> Ministry of Social Justice and
                                    Empowerment</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> Ministry of Women and Child
                                    Development</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> PMMVY : PM Matru Vandana Yojana</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> Senior Citizen Pension</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> Widow Pension Schemes</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> Lorem ipsum dolor sit amet
                                    consectetur</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> Lorem ipsum dolor sit</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> Widow Pension/Loan Schemes</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> PM Kisan Samridhi Yojna</a>
                                <a href="#" class="text-dark list-group-item list-group-item-action"><i
                                        class="fas fa-hand-point-right me-2"></i> PM Kisan Samridhi Nidhi Yojna</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card mb-3">
                        <div class="card-body p-1 text-center">
                            ...
                            <img src="assets/images/map1.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body p-1 text-center">
        ...
        <div class="container">
            ...
            <div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
                <div class="col text-center">
                    <img src="assets/images/scheme1.jpg" class="img-thumbnail rounded-circle" width="160"
                        alt="">
                    <p class="text-dark h6 my-3">Schemes for<br>Children</p>
                    <a href="#" class="btn btn-dark btn-sm">View More</a>
                </div>
                <div class="col text-center">
                    <img src="assets/images/scheme2.jpg" class="img-thumbnail rounded-circle" width="160"
                        alt="">
                    <p class="text-dark h6 my-3">Schemes for<br>Women</p>
                    <a href="#" class="btn btn-dark btn-sm">View More</a>
                </div>
                <div class="col text-center">
                    <img src="assets/images/scheme3.jpg" class="img-thumbnail rounded-circle" width="160"
                        alt="">
                    <p class="text-dark h6 my-3">Schemes for<br>Senior Citizens</p>
                    <a href="#" class="btn btn-dark btn-sm">View More</a>
                </div>
                <div class="col text-center">
                    <img src="assets/images/scheme4.jpg" class="img-thumbnail rounded-circle" width="160"
                        alt="">
                    <p class="text-dark h6 my-3">Schemes for Persons<br>with Disabilities</p>
                    <a href="#" class="btn btn-dark btn-sm">View More</a>
                </div>
                <div class="col text-center">
                    <img src="assets/images/scheme5.jpg" class="img-thumbnail rounded-circle" width="160"
                        alt="">
