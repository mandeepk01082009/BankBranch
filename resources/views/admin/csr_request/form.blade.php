        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('store_csr_request') }}" method="post">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="details" placeholder="Details" type="text" class="form-control"
                                rows="4" name="details" autocomplete="details" autofocus>{{ old('details') }} </textarea>
                            @error('details')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('estimated_expense') is-invalid @enderror" type="text"
                                name="estimated_expense" id="estimated_expense" placeholder="Estimated Expense" />
