<div class="container-xxl position-relative bg-white d-flex p-0">
    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            <a href="{{ route('bank_nodals_dashboard') }}" class="navbar-brand mx-4 mb-3">
            ...
            <div class="d-flex align-items-center ms-4 mb-4">
                ...
                <div class="ms-3">
                    <h6 class="mb-0">
                        @auth('bank_nodals')
                            <p>{{ auth('bank_nodals')->user()->dco_name }}</p>
                        @endauth
            ...
            <div class="navbar-nav w-100">
                <a href="{{ route('bank_nodals_dashboard') }}"
                    class="nav-item nav-link  {{ request()->is('bank-nodals') ? 'active' : '' }}"><i
                        class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                <a href="{{ route('bank_nodals') }}"
                    class="nav-item nav-link {{ request()->is('bank-nodals/bank_nodals') ? 'active' : '' }}"><i
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-lg-inline-flex">
                            @auth('bank_nodals')
                                <p>{{ auth('bank_nodals')->user()->dco_name }} (Bank Nodal)</p>
                            @endauth
