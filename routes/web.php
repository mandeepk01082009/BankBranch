...
Route::group(['namespace' => 'admin','prefix'=>'bank-branches', 'middleware' => ['auth', 'verified', 'check_user_type:bank_branch']], function() {
    Route::get('/', function () {
...
Route::group(['namespace' => 'admin', 'prefix' => 'department', 'middleware' => ['auth', 'verified', 'check_user_type:department']], function() {
    Route::get('/', function () {
...
Route::group(['namespace' => 'admin', 'prefix' => 'cms-admin', 'middleware' => ['auth', 'verified', 'restrict_special_access']], function() {
    Route::get('/', function () {
